...
class ChatAttachment {
  ChatAttachment(
      {required this.url, this.id, this.name, this.mimetype, this.size});
  ...
  factory ChatAttachment.fromBackend(dynamic json,
  ...
  bool get isLocal =>
      (url.startsWith('file://') || !Uri.parse(url).hasScheme) &&
      File(url).existsSync();
  ...
  Map<String, dynamic> toMap() =>
      {'url': url, 'name': name, 'type': mimetype, 'size': size, 'id': id};
}
